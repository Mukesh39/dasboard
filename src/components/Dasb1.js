...
const Dasb1 = () => {
 ...
 {/* {
    meetingRooms : "Meeting Room 1",
    positions :  "12 Positions", 
    date : "Start from 12 Jan, 2023 - Ends at 15 Jan, 2023"
  } , */}

            <div className="section4a">
                <h4>Assign Contractors</h4>
                {  meetingRoomsData.map((meetinRoom)=>(
                  <div className="meetingRooms">
                  <div className="meetingroomDetails">
                      <h6>{meetinRoom.meetingRooms} </h6>
                      <img src={star} alt="star" />
                      <p>{meetinRoom.positions}</p>
                  </div>
